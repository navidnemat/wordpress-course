                ...
                {searchIsOpen && (
                    <div className="absolute z-999 top-0 left-0 max-w-[1440px] mx-auto px-4 sm:px-10 lg:px-15 bg-white w-full py-5">
                        ...
                        <div className="flex items-center flex-nowrap gap-4">
                            ...
                            <button className="flex justify-center gap-5 bg-teal-400 px-3 py-3 rounded-full transition-all duration-200 hover:shadow-[0_0_10px_#00D5BE] whitespace-nowrap lg:w-30">
                                <span>جستجو</span>
                            </button>
                        </div>
